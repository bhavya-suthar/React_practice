...
import moduleName from '../../Components/CartMessage/CartMessage'
...
const ProductSinglePage = () => {
  ...
  console.log("🚀 ~ increaseQty ~ increaseQty:", increaseQty)
  ...
  console.log("🚀 ~ decreaseQty ~ decreaseQty:", decreaseQty)
  ...
  console.log("🚀 ~ ProductSinglePage ~ discountedPrice:", discountedPrice)
            ...
            <div className="product-single-r">
              <div className="product-details font-manrope">
                ...
                <div className="info flex align-center flex-wrap fs-14">
                  ...
                  <div className="vert-line"></div>
                  <div className="brand">
                    <div className="text-orange fw-5">Category:</div>
                ...
                <div className="qty flex align-center my-4">
                  ...
                  <button onClick={()=>increaseQty()} type="button" className="qty-increase flex align-center justify-center">
                    <i className="fas fa-plus"></i>
                  </button>
                  </div>
                   {(product?.stock === 0) ? <div className="qty-error text-uppercase bg-danger text-white fs-12 ls-1 mx-2 fw-3">Out of stock</div> : ""
                   }
                </div>
